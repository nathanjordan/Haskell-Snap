...
/* package MonadCatchIO-transformers-0.2.2.3 */
#define VERSION_MonadCatchIO_transformers "0.2.2.3"
...
/* package data-lens-template-2.1.2 */
#define VERSION_data_lens_template "2.1.2"
#define MIN_VERSION_data_lens_template(major1,major2,minor) (\
  (major1) <  2 || \
  (major1) == 2 && (major2) <  1 || \
  (major1) == 2 && (major2) == 1 && (minor) <= 2)

/* package heist-0.6.0.1 */
#define VERSION_heist "0.6.0.1"
...
/* package snap-0.6.0.2 */
#define VERSION_snap "0.6.0.2"
#define MIN_VERSION_snap(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  6 || \
  (major1) == 0 && (major2) == 6 && (minor) <= 0)

/* package snap-core-0.6.0.1 */
#define VERSION_snap_core "0.6.0.1"
#define MIN_VERSION_snap_core(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  6 || \
  (major1) == 0 && (major2) == 6 && (minor) <= 0)

/* package snap-server-0.6.0.1 */
#define VERSION_snap_server "0.6.0.1"
